...
def main() -> None:
    ...
    tracks = {
        ...
        "people_stand": {
            ...
            "sy": [[0, 1], [4600, 0.94], [4780, 1.0, "settle"], [5000, 1]],
        },
        "people_float": {
    ...
    fxlist = [
        ...
        dict(kind="light_sweep", t0=950, t1=1400, footprint=[0, 300, W, H],
        ...
        dict(kind="scan_sweep", t0=3400, t1=3950, footprint=[bmx - 90, 0, bmx + bmw + 90, bmy + bmh],
             params=dict(y0=620, y1=30, band=30, alpha=0.9, color=[170, 242, 255])),
        dict(kind="scan_sweep", t0=4600, t1=4900, footprint=[bx - 60, by - 260, bx + bw + 60, by + bh + 30],
